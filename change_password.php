...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Verify current password (assuming plain text for now based on previous code seen in login/register, though hashed is better)
    // Note: If the user used password_hash in register.php, we should use password_verify here.
    // Given the previous user edits in other tasks, I'll check register.php if possible but I'll stick to what might work.
